      ...
      <div className="xl:col-span-3 grid grid-cols-1 md:grid-cols-3 gap-8 mb-10">
        <div className="bg-white p-8 rounded-[2rem] border border-slate-100 shadow-xl shadow-black/[0.02]">
          ...
          <div className="flex items-baseline gap-2">
            <p className="text-4xl font-black text-[var(--primary-dark)]">$1,240.50</p>
        ...
        <div className="bg-white p-8 rounded-[2rem] border border-slate-100 shadow-xl shadow-black/[0.02]">
          ...
          <div className="flex items-baseline gap-2">
            <p className="text-4xl font-black text-[var(--primary-dark)]">{activeListings.length}</p>
            <span className="text-slate-400 text-xs font-bold uppercase">Active Listings</span>
          </div>
          <div className="mt-8">
            <div className="h-2.5 bg-slate-100 rounded-full overflow-hidden">
              <div className="bg-[var(--primary-dark)] h-full w-[70%] rounded-full shadow-[0_0_10px_rgba(17,212,33,0.4)]"></div>
            </div>
        ...
        <div className="bg-white p-8 rounded-[2rem] border border-slate-100 shadow-xl shadow-black/[0.02]">
          ...
          <p className="text-4xl font-black text-[var(--primary-dark)]">5</p>
