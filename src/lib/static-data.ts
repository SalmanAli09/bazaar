...
export const staticProducts: Product[] = [
  ...
  // Products from search results
  {
    ...
    seller_id: 'user-1',
    category_id: 'clothing',
    ad_title: 'Wedding Sherwani - Maroon Embroidered',
    city: 'Islamabad',
    condition: 'Like New',
    description: 'Elegant wedding sherwani with intricate maroon embroidery. Perfect for traditional occasions. High-quality fabric with detailed craftsmanship.',
    product_pictures: ['https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=600'],
    selling_price: 12000,
  ...
  },
  {
    ...
    seller_id: 'user-1',
    category_id: 'clothing',
    ad_title: 'Gently Used Khaadi Lawn Suit',
    city: 'Karachi',
    condition: 'Like New',
    description: 'Beautiful Khaadi lawn suit in gently used condition. Perfect for summer wear. Includes shirt and trouser set with matching dupatta.',
    product_pictures: ['https://images.unsplash.com/photo-1594633312681-425c7b97ccd1?w=600'],
    selling_price: 2500,
    original_price: 5800,
    negotiable_price: true,
    featured: true,
  ...
  },
  {
    ...
    seller_id: 'user-1',
    category_id: 'clothing',
    ad_title: 'Men\'s Shalwar Kameez - White Cotton',
    city: 'Lahore',
    condition: 'New',
    description: 'Traditional white cotton shalwar kameez set. Comfortable and breathable fabric, perfect for daily wear or formal occasions.',
    product_pictures: ['https://images.unsplash.com/photo-1594633312681-425c7b97ccd1?w=600'],
    selling_price: 1800,
    original_price: 3200,
    negotiable_price: true,
